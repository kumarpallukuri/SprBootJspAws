          ...
          <div class="col-xs-offset-4 col-xs-4">
              <div class="well">
                  <form id="registerForm" name="registerForm" novalidate ng-submit="register();">
                       <div class="form-group" ng-show="!alreadyRegistered" ng-class="{ 'has-error' : registerForm.profName.$invalid && !registerForm.profName.$pristine }">
                      ...
                      <div class="form-group" ng-show="!alreadyRegistered" ng-class="{ 'has-error' : registerForm.password.$invalid && !registerForm.password.$pristine }">
